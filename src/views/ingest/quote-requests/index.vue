  ...
  <section class="quote-page">
    <div class="page-head">
      ...
      <div class="head-actions">
        <el-button :icon="Box" @click="goProductBom">产品 BOM 准备</el-button>
...
import { Box, Refresh, Search, Upload } from '@element-plus/icons-vue'
...
function goProductBom() {
  router.push('/ingest/quote-request-products/bom')
}
